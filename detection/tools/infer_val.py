...
def eval(anno_gts_file, dets_file):
    eval_gt = COCO(anno_gts_file)
    eval_dt = eval_gt.loadRes(dets_file)
...
def infer_crop_imgs():
    ...
    double_thresh = 0.3
    # 检测结果json保存路径
    res_json_path = "/home/megstudio/workspace/megengine-traffic-sign-det/detection/val_json/val.json"
    # 模型config路径
    ...
    val_anno_ori_file = "/home/megstudio/dataset/dataset-2805/annotations/val.json"
    ...
    iou_thr = 0.55
    final_json_file = "/home/megstudio/workspace/megengine-traffic-sign-det/detection/val_json/final_val.json"
    ensemble_wbf_full_img(res_json_path, val_anno_ori_file, iou_thr, final_json_file)
    eval(val_anno_ori_file, final_json_file)
