...
def infer_crop_imgs():
    ...
    # 验证集/测试集切片图片根目录
    img_root = "/home/megstudio/dataset/traffic5/images"
    # 验证集/测试集所有切片list
    ...
    val_anno_ori_file = "/home/megstudio/dataset/traffic5/annotations/test.json"
    ...
    for i in tqdm(range(img_df.shape[0])):
        ...
        if img_w >= 2000:
            test_scales = [
                [img_h, img_w], [img_h*1.1, img_w*1.1], [img_h*1.2, img_w*1.2], [img_h*1.3, img_w*1.3], [img_h*0.9, img_w*0.9],
                [img_h*1.4, img_w*1.4],[img_h*1.5, img_w*1.5], [img_h*1.6, img_w*1.6]
            ]
        else:
            test_scales = [
